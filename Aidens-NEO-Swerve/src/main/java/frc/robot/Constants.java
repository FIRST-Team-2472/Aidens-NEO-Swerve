...
public final class Constants {
  ...
  public static final class DriveConstants{
    ...
    //Front Left
    public static final int kFrontLeftDriveMotorPort = 53;
    public static final int kFrontLeftTurningMotorPort = 51; // fill these out then delete this comment
    public static final boolean kFrontLeftDriveEncoderReversed = false;
    public static final boolean kFrontLeftTurningEncoderReversed = false;
    public static final int kFrontLeftDriveAbsoluteEncoderPort = 61;
    public static final double kFrontLeftDriveAbsoluteEncoderOffsetAng = 263.2;
    ...
    public static final double kFrontRightDriveAbsoluteEncoderOffsetAng = 164.75;
    ...
    public static final double kBackLeftDriveAbsoluteEncoderOffsetAng = 193.55;
    ...
    public static final double kBackRightDriveAbsoluteEncoderOffsetAng = 124.95;
